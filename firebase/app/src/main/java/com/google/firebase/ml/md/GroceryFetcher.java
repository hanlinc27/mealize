...
public class GroceryFetcher {
    ...
    public ArrayList<GroceryStore> storeList = new ArrayList<>();
...
//    }
    ...
    public ArrayList<GroceryStore> getGroceryStores(String postalCode) throws Exception {
...
//    public void getGroceryInfo(String postalCode) throws IOException, ParseException {
